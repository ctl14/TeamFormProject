...
/////////////Birthdate Tests/////////////////////////////////////////////////////////
	...
	it('should display error when birthday input is entered and cleared', function(){
		var birthdateInput = element(by.model('birthdate'));
		var dateInvalid = element(by.id('dateInvalid'));
		var tooYoung = element(by.id('tooYoung'));
		birthdateInput.sendKeys('01/22/2000');
	...
	it('should not display an error message when birthdate is untouched', function(){
		var dateInvalid = element(by.id('dateInvalid'));
		var tooYoung = element(by.id('tooYoung'));
		expect(dateInvalid.isDisplayed()).toEqual(false);
		expect(tooYoung.isDisplayed()).toEqual(false);
...
/////////////Submit Button Tests/////////////////////////////////////////////////////////
	...
	it('should disable the submit button if the birthday field is blank', function(){
		var birthdateInput = element(by.model('birthdate'));
		var nameInput = element( by.model('lastName') );
		var passwordInput = element( by.model('password') );
		var confirmPasswordInput = element( by.model('confirmPassword') );
	...
	it('should disable the submit button if the entered birthdate is younger than 13', function(){
		var birthdateInput = element(by.model('birthdate'));
		var nameInput = element( by.model('lastName') );
		var passwordInput = element( by.model('password') );
		var confirmPasswordInput = element( by.model('confirmPassword') );
		...
		confirmPasswordInput.sendKeys('password');
		emailInput.sendKeys('husky');
		birthdateInput.sendKeys('01/01/2014');

		expect( submitButton.isEnabled()).toEqual(false);

	})

	it('should diable the submit button if the entered birthdate is not in valid form', function(){
		var birthdateInput = element(by.model('birthdate'));
		var nameInput = element( by.model('lastName') );
		var passwordInput = element( by.model('password') );
		var confirmPasswordInput = element( by.model('confirmPassword') );
